        ...
        <main>
            ...
            <div class="row flex-lg-row-reverse align-items-center g-5 py-5 px-5 ms-4">
                ...
                <div class="col-lg-6">
                    ...
                    <p class="fs-5">Bienvenido a Panadería Coco, el hogar del sabor auténtico y la tradición horneada. Somos una franquicia apasionada por llevar a tu mesa 
                        la frescura y la calidad en cada bocado. En Panadería Coco, nos enorgullece fusionar la artesanía de antaño con los sabores contemporáneos para 
                        ofrecerte productos de panadería excepcionales. Desde nuestro primer horno hasta tu mesa, 
                        cada producto es elaborado con ingredientes selectos y un toque de dedicación que refleja nuestra pasión por la excelencia.</p>
            ...
            <div class="px-4 py-5 my-5 text-center">
                ...
                <div class="col-lg-6 mx-auto">
                    <p class="fs-4 mb-4">Ofrecemos todas las facilidades de pago para que puedas disfrutar de todos nuestros servicios sin preocuparte por los metodos.</p>
