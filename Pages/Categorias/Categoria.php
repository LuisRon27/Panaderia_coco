    ...
    <div class="container-fluid mt-2">
        ...
        <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3 justify-content-center mt-3">
            <div class="bg-primary-subtle me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden rounded">
                <div class="my-3 py-3">
                    <a href="../Productos/Productos.php?IDCategoria=1"
                        class="btn btn-outline-secondary fs-3 w-100 ">Mundo Dulce</a>
            ...
            <div class="bg-primary-subtle me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden rounded">
                <div class="my-3 p-3">
                    <a href="../Productos/Productos.php?IDCategoria=2"
                        class="btn btn-outline-secondary fs-3 w-100">Mundo Salado</a>
        ...
        <footer class="py-3 my-4">
            <ul class="nav justify-content-center border-bottom pb-3 mb-3">
                <li><a href="#" class="nav-link px-2 text-body-secondary">Productos</a>
                </li>
